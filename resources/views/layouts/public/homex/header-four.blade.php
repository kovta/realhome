            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand pl-0" href="{{ url('/') }}"><img class="nav-logo" src="{{ asset('images/logo/realhome.svg') }}" alt="realhome logo" style="width: 150px; height:auto;"></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                --}}
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('realEstatePublicList') }}">@lang('public.mainmenu_search_label')</a>
                                </li>
                                <li class="nav-item">
                            ...
                            @else
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item d-lg-none" style="border-top: 1px dotted #0d1432; text-align:right;">
                                        @if (App::getLocale() === 'en')
                                            <a class="nav-link" href="{{route('language', 'hu')}}">Váltás magyar nyelvre</a>
                                        @else
                                            <a class="nav-link" href="{{route('language', 'en')}}">Switch to English</a>
